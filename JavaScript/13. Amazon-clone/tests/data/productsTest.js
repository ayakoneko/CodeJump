...
describe('test suite: Appliance', () => {
    ...
    beforeEach(() => {
        appliance = new Appliance({
            ...
            type: "appliance",
            instructionsLink: "images/appliance-instructions", 
            warrantyLink: "images/appliance-warranty", 
        });
    });
    ...
    it('has the correct properties', () => {
        ...
        expect(appliance.instructionsLink).toEqual('images/appliance-instructions');
        expect(appliance.warrantyLink).toEqual('images/appliance-warranty');
    });
    ...
    it('display a size chart link in extraInfoHTML', () => {
        expect(appliance.extraInfoHTML()).toContain('<a href="images/appliance-instructions" target="_blank">Instructions</a>');
        expect(appliance.extraInfoHTML()).toContain('<a href="images/appliance-warranty" target="_blank">Warranty</a>');
    });
});